...
Project documentation lives in [`./docs`](./docs). The full documentation landing page is **[Documentation Index](./docs/index.md)** - Project overview and generated docs map.
...
- **[NestJS Backend Reference](./docs/nestjs-backend.md)** - Separate backend implementation reference
