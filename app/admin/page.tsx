    ...
    <div className="min-h-screen bg-[#FFF9F0]">
      ...
      <main className="container mx-auto max-w-md px-4 py-8">
        <div className="rounded-2xl bg-white p-6 text-center shadow-xl">
          <h1 className="mb-2 text-xl font-bold text-[#24324A]">Admin Link Unavailable</h1>
          <p className="text-[#24324A]/70">
            AIRTABLE_BASE_ID and AIRTABLE_INTERFACE_DASHBOARD_PAGE_ID are required to open the Airtable admin interface.
          </p>
        </div>
      </main>
    </div>
