...
- [x] Re-read the source story and dependent decisions before implementation (AC: 1, 2, 3, 4, 5, 6, 7)
...
- [x] Implement `Implement Staff Sign-In And Role Routing` according to the acceptance criteria (AC: 1, 2, 3, 4, 5, 6, 7)
