...
- [x] Implement `Create Program-Scoped Staff Identity Schema` according to the acceptance criteria (AC: 1, 2, 3, 4, 5, 6)
...
- Story source: `_bmad-output/planning-artifacts/epics.md` section `Story 2.1: Create Program-Scoped Staff Identity Schema`.
